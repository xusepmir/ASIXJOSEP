...
<html lang="en">
  <head >
    ...
    <label for="ou">Quina ou vol esborrar? </label>
    <br>
    <br>
    <p>(Atenció sols se pot borrar una ou una vegada no tinga objectes asociats)</P>
    <br>
...
if (isset($_POST['ou'])) {
    ...
    $output = shell_exec("sudo bash menosou.sh $ou");
