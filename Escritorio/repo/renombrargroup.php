...
<form method="post">
    ...
    <label for="group"> Que grup vols canviar de nom? </label>
    <br>
    <br>
    <input type="text" id="group" name="group">
    <br>
    <br>
    <label for="group"> Que nom li vols posar ? </label>
    <br>
    <br>
    <input type="text" id="group2" name="group2">
...
<?php
    ...
    $output = shell_exec("sudo bash renamegroup.sh $group $group2");
    echo "<pre>$output</pre>";
