...
<html lang="en">
  <head >
    ...
    <div class="p-3 mb-3 bg-secondary">
      ...
      <div class="alert alert-secondary" role="alert">
        ...
        <p> Tornar a Gestusu convencional'<a href="./index.html">Index</a>!</p>
  ...
  <div class="row">
    ...
    <br>
      <div class="card">
        <img src="./soon.png" class="card-img-top" alt="Card image cap">
        <div class="card-body">
          <h5 class="card-title">Ampliacions</h5>
          <p class="card-text"><br>Visualitza totes les seccions disponibles en un futur.</p>
          <a href="./gestusufutur.php" class="btn btn-primary">Ves</a>
        </div>
      </div>
    </div>
