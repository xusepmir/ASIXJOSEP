  ...
  <head >
    ...
    <div class="p-4 mb-4 bg-secondary">
      ...
      <div class="alert alert-secondary" role="alert">
        ...
        <p> Actualitzant.., fer clic per a tornar a l'<a href="./index.html">Index</a>!</p>
    ...
    <br>
     ...
     <div class="p-4 mb-4 bg-white text-black">
...
$output = shell_exec('sh actualitzar.sh');

// Mostrar la salida en una ventana emergente
echo "<pre>$output</pre>";

// Obtener el código de salida
$exit_code = substr(trim($output), -1);

// Comprobar el código de salida
if ($exit_code == 0) {
  echo "La comanda s'ha executat amb exit.";
} else {
  echo "Algo ha fallat.";
}
