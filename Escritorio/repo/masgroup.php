...
<form method="post">
    ...
    <label for="group">Com es dirà el nou grup? </label><br>
    <br>
    <input type="text" id="group" name="group" required>
    <br>
    <br>

    <label for="ou">A quina ou estará asignat? </label>
    <br>
    <input type="text" id="ou" name="ou" required>
    <br>
    <br>
    <label for="guid">Quin grupid té? </label>
    <br>
...
if (isset($_POST['group'])) {
    ...
    $output = shell_exec("sudo bash grupo.sh $group $ou $guid");
    echo "<pre>$output</pre>";
}
